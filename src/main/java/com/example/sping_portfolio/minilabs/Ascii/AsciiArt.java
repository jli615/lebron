package com.example.sping_portfolio.minilabs.Ascii;
...
public class AsciiArt {
    ...
    public static void main(String[] args) {
        Picture picture = new Picture("src/main/resources/static/images/thumbsup.png");
        ...
        for (int i = 0; i < rows; i+=3) {
            for (int j = 0; j < cols; j+=3) {
                ...
                double mean = (image[i][j] + image[i][j+1]+ image[i][j+2]+
